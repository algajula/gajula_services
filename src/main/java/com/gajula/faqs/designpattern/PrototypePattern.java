package com.gajula.faqs.designpattern;

/*The prototype pattern is used when the Object creation is costly and requires a lot of time 
...
It should not be done by any other class. However, whether to use the shallow or 
